...
const styles = StyleSheet.create({
  ...
  actionBtn: { flex: 1, flexDirection: 'row',  justifyContent: 'center', alignItems: 'center',     paddingVertical: 12, borderRadius: 10, alignItems: 'center' , marginRight: 8, marginLeft: 10,},
